...
export const projects: Project[] = [
    {
        title: "Finaura",
        description: "A personal finance dashboard to track goals, monthly insights, and financial progress with a clean UI.",
    ...
    },
    {
        ...
        description: "Machine learning model which is used to screen the resume and predict the likelihood of the candidate placement.",
